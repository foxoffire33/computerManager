...
class ComputerModelController extends Controller
{
    ...
    {
        $searchModel = new ComputerModelSearch();
    ...
    /**
     * Displays a single ComputerModel model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing ComputerModel model.
    ...
    /**
     * Deletes an existing ComputerModel model.
