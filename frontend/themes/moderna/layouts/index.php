                    ...
                    <ul class="slides">
                        <li>
                            ...
                            <div class="flex-caption">
                                ...
                                <p>Via ComputerOnderhouden.nl kunt u snel en simpel een onderhoudsbeurt aanvragen voor uw computer</p> 
                        ...
                        <li>
                            ...
                            <div class="flex-caption">
                                ...
                                <p>Nadat uw computer bij ons is geweest kunt u zien wat er in uw computer zit en welke programma's er op staan</p> 
                                <?= Html::a('Reparatie aanvragen', '/computer-onderhoud-of-reparatie-aanvragen', ['class' => 'btn btn-theme']) ?>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="flex-caption">
                                ...
                                <p>Uw kunt per computer zien wat de status van de reparatie is en wat wij gedaan hebben</p> 
                                <?= Html::a('Reparatie aanvragen', '/computer-onderhoud-of-reparatie-aanvragen', ['class' => 'btn btn-theme']) ?>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="col-lg-4">
                        <div class="box">
                            <div class="box-gray aligncenter">
                                ...
                                <p>
                                    Een medewerker van Computeronderhouden.nl komt bij u langs, inventariseert uw computergebruik en maakt direct een schatting van de kosten om uw computer weer snel te laten werken.
                                    <br /><br /><br /><br />
                                </p>
                    ...
                    <div class="col-lg-4">
                        <div class="box">
                            <div class="box-gray aligncenter">
                                ...
                                <p>
                                    Bij Computeronderhouden.nl kunt u een onderhoudsabonnement afsluiten. Zo ontvangt u periodiek (vaak 1x per half jaar) een e-mail voor het inplannen van een afspraak. Na het inplannen komt een medewerker van Computeronderhouden.nl bij u langs en voert het onderhoud bij u uit. 
